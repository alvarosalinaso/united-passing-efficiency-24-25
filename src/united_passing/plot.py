...
def plot_top_passers(
    ...
    fig.text(
        0.01,
        0.01,
        "Insight: el líder destaca sobre la media → priorizar su rol en salida de balón.",
        fontsize=8,
        style="italic",
        color=_DARK,
    )
...
def plot_prog_ratio_scatter(
    ...
    fig.text(
        0.01,
        0.01,
        "Insight: cuadrante superior-derecho = volumen + progresión → perfiles clave para transición.",
        fontsize=8,
        style="italic",
        color=_DARK,
    )
